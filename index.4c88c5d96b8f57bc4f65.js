...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _main__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../main */ \"./src/js/main.js\");\n/* harmony import */ var _banner__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../banner */ \"./src/js/banner.js\");\n/* harmony import */ var _scss_main_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../scss/main.scss */ \"./src/scss/main.scss\");\n\n\n\nconst articlesInner = document.querySelector('.articles__inner');\n(0,_banner__WEBPACK_IMPORTED_MODULE_1__.getDataFeatured)().then(data => {\n  (0,_banner__WEBPACK_IMPORTED_MODULE_1__.createBannerTop)('banner', data);\n});\n(0,_main__WEBPACK_IMPORTED_MODULE_0__.getData)(`${_main__WEBPACK_IMPORTED_MODULE_0__.url}blog/articles/`).then(data => {\n  for (let i = 0; i < data.length; i++) {\n    const articlesItem = (0,_main__WEBPACK_IMPORTED_MODULE_0__.createArticlesItem)(data[i]);\n    articlesInner.append(articlesItem);\n    const article = (0,_main__WEBPACK_IMPORTED_MODULE_0__.createArticle)('articles__article article_sm', data[i]);\n    articlesItem.append(article);\n  }\n});\n\n//# sourceURL=webpack://webpackbaseconfig/./src/js/pages/blog.js?");
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["src_scss_main_scss"], () => (__webpack_require__("./src/js/pages/blog.js")))
